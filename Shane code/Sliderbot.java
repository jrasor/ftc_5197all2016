...
public class Sliderbot {
    ...
    */
    ...
    public void turnAngleRadiusDrive(double speed, double angle, double radius) {
        ...
        encoderDrive(leftSpeed, rightSpeed, leftSpeed, rightSpeed, leftArc, rightArc, leftArc, rightArc);
    ...
    //    at full speed, and travel the full arc.
    ...
    private String stepTowardBeaconWestCoast (String whichBeacon) {
        ...
        final double FINAL_APPROACH_SPEED = 0.2; // 0.1 is just a bit too slow.
