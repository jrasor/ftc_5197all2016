...
import org.firstinspires.ftc.teamcode.HardwareRangerbot;
 ...
 *      // still stops right motor prematurely.
 ...
 *   - Drive backward for 12 inches, leaving it 24" from starting point.
 *  Besides the 3-move script, there are two calibration jobs: run a distance, make some turns.
 *
 ...
 *  with drive wheels front, at lower center of a 3' x 3' area in which to perform,
 *  run the opmode, sit back and watch the show.
 */

@Autonomous(name="Rangerbot: Auto Drive By Encoder 2", group="Rangerbot")
@Disabled
public class RangerbotAutoDriveByEncoder02 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        jobDistanceCalibrate(60); // run 60 inches
        //    jobAngleCalibrate(10* Math.PI); // 5 full turns
        //    jobRunScript();

        //    telemetry.addData("Job", "Complete");
        //    telemetry.update();
    }
    ...
    //    Wrapper for encoderDrive. Just go forward.
