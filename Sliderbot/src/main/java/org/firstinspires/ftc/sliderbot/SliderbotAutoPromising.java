...
@Autonomous(name="Sliderbot RED BEACONS Promising", group="Sliderbot")
//@Disabled
public class SliderbotAutoPromising extends LinearOpMode {
    ...
    public void jobRunScript(){
        ...
        robot.driveSideways(Sliderbot.STRAIGHT_SPEED/4.0, 0.7); // ** This invites trouble.
