...
public class SliderbotAutoTESTRedBeacons extends LinearOpMode {
    ...
    private final double START_SPEED = 1.00;
    private final double STRAIGHT_SPEED = 0.60;
    private final double FAST_SPEED = 0.825;
    ...
    public void jobRunScript(){
        ...
        robot.driveSideways(Sliderbot.STRAIGHT_SPEED/4.0, 1.0); // ** This invites trouble.
        ...
        robot.turnLeft(.8, WIDE_TURN_RATIO, -70.0);
        ...
        //   We will search from there with the color sensor.
        robot.driveStraight(Sliderbot.STRAIGHT_SPEED/4.0, -5.0);
        robot.driveSideways(Sliderbot.STRAIGHT_SPEED/4.0, 0.7);
        seeColor = false;
        while(!seeColor) {
            colorCcache = colorCreader.read(0x04, 1);
