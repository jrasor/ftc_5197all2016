...
@Autonomous(name="Sliderbot RED AUTO", group="Interleague")
//@Disabled
public class SliderbotRedAuto extends LinearOpMode {
    ...
    private final double STRAIGHT_SPEED = 0.90;
    private final double TURN_SPEED = 0.90;
    ...
    public void jobRunScript(){
        ...
        robot.driveStraight(Sliderbot.STRAIGHT_SPEED/2.0, -4.5);
        robot.driveSideways(Sliderbot.STRAIGHT_SPEED/2.0, 0.95); // ** This invites trouble.
        ...
        //sleep(IMAGE_ID_TIME);
        robot.initEncodedDrive(hardwareMap);
        robot.driveStraight(0.65, -48.0);
        robot.turnAngle(robot.TURN_SPEED, -Math.PI / 2);
        robot.driveStraight(0.65, -7.0);
        robot.initEncodedDrive(hardwareMap);
        robot.goToBeacon();
        */
        // ... turn 90 degrees left to present sensors and pusher to the
        ...
        robot.driveStraight(Sliderbot.STRAIGHT_SPEED/2.0, -4.5);
        robot.driveSideways(Sliderbot.STRAIGHT_SPEED/2.0, 1.3); // ** This invites trouble.
        // ** We can eliminate it with a different target X.
